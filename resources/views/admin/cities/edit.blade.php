...
<div class="container mx-auto px-6 py-8 max-w-4xl">
    ...
    <h1 class="text-3xl font-bold text-dark-turquoise mb-6">Editar Ciudad</h1>
    ...
    <form action="{{ route('admin.cities.update', $city) }}" method="POST" class="bg-white rounded-lg shadow p-6">
        @csrf
        @method('PUT')
