...
<div class="container mx-auto px-6 py-8 max-w-4xl">
    ...
    <h1 class="text-3xl font-bold text-dark-turquoise mb-6">Editar Courier</h1>
    ...
    <form action="{{ route('admin.couriers.update', $courier) }}" method="POST" class="bg-white rounded-lg shadow p-6">
        @csrf
        @method('PUT')
