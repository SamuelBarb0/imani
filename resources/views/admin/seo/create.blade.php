...
<div class="container mx-auto px-6 py-8">
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-dark-turquoise mb-2">Nueva Configuración SEO</h1>
        <p class="text-gray-600">Configura los meta tags para una página específica</p>
    </div>

    <form action="{{ route('admin.seo.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-lg shadow-lg p-6">
        @csrf

        <!-- Page Selection -->
        <div class="mb-6">
            <label class="block text-sm font-semibold text-gray-700 mb-2">Página *</label>
            <select name="page" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-dark-turquoise focus:border-transparent">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="og_description" rows="3" maxlength="500"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-dark-turquoise focus:border-transparent"
                        placeholder="Deja vacío para usar Meta Description">{{ old('og_description') }}</textarea>
                ...
                <div>
                    ...
                    <input type="file" name="og_image" accept="image/*"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-dark-turquoise focus:border-transparent">
                    <p class="text-xs text-gray-500 mt-1">Recomendado: 1200x630px (Max 2MB)</p>
                    @error('og_image')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
        ...
        <div class="mb-8">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="twitter_title" value="{{ old('twitter_title') }}" maxlength="255"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-dark-turquoise focus:border-transparent"
                        placeholder="Deja vacío para usar Meta Title">
                    @error('twitter_title')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                ...
                <div>
                    ...
                    <textarea name="twitter_description" rows="3" maxlength="500"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-dark-turquoise focus:border-transparent"
                        placeholder="Deja vacío para usar Meta Description">{{ old('twitter_description') }}</textarea>
                ...
                <div>
                    ...
                    <input type="file" name="twitter_image" accept="image/*"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-dark-turquoise focus:border-transparent">
                    <p class="text-xs text-gray-500 mt-1">Recomendado: 1200x675px (Max 2MB)</p>
                    @error('twitter_image')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
