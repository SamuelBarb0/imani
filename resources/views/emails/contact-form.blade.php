...
<div style="background-color: white; padding: 30px; border-radius: 8px; margin-bottom: 20px;">
    ...
    <p style="margin: 0 0 5px 0; color: #333; line-height: 1.6; font-weight: bold;">Resumen de tu consulta:</p>
    <div style="background-color: #f8f8f8; padding: 20px; border-radius: 6px; margin: 5px 0;">
        <table style="width: 100%;" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td style="padding: 8px 0; color: #333;"><strong>Mensaje:</strong> {{ $userMessage }}</td>
            </tr>
        </table>
    </div>
